...
const ACTIVITIES = [
  // --- Social / Party ---
  { key: 'drink_beer', name: 'Drink a beer', category: 'Social', xp: 10, rarity: 'common', icon: '🍺' },
  { key: 'darty', name: 'Throw or attend a darty (day party)', category: 'Social', xp: 25, rarity: 'uncommon', icon: '☀️' },
  ...
  { key: 'tank_top', name: 'Wear a tank top', category: 'Social', xp: 10, rarity: 'common', icon: '🎽' },
  { key: 'mob_with_boys', name: 'Mob out with your boys', category: 'Social', xp: 15, rarity: 'common', icon: '👬' },
  ...
  { key: 'walk_of_shame', name: 'Do the walk of shame back to the dorm', category: 'Romance', xp: 20, rarity: 'uncommon', icon: '🚶' },
  ...
  { key: 'formal_greek', name: 'Attend a Greek mixer', category: 'Greek Life', xp: 20, rarity: 'common', icon: '🎉' },
  { key: 'date_party', name: 'Get invited to a date party', category: 'Greek Life', xp: 20, rarity: 'uncommon', icon: '💐' },
  { key: 'letters', name: 'Wear your letters on campus', category: 'Greek Life', xp: 10, rarity: 'common', icon: '🔤' },
  { key: 'philanthropy', name: 'Participate in a philanthropy/charity event', category: 'Greek Life', xp: 25, rarity: 'uncommon', icon: '❤️' },
  ...
  { key: 'wake_up_confused', name: 'Wake up not knowing where you are', category: 'Rites of Passage', xp: 20, rarity: 'uncommon', icon: '🌀' },
  { key: 'make_bread', name: 'Make some bread', category: 'Rites of Passage', xp: 20, rarity: 'uncommon', icon: '🍞' },
